...
public class InMemoryBenchMarkMain
{
    public static void main(String[] args) throws RunnerException, IOException
    {
        ...
        for (int x = n_elements_start; x <= n_elements_end; x += n_elements_step)
        {
            ...
            createPropertyFile(i, 0, 0, inputFile, propsFile);
    ...
    private static void runMemoryBasedBenchmark(int i) throws IOException, RunnerException
    {
        ...
        Options opts = new OptionsBuilder()
                ...
                .result(PropertiesHandler.getInstance().getProperty("benchmark.mway-merge-sort.jmh.results-dir")+"/memory_results_"+i +"_.csv")
